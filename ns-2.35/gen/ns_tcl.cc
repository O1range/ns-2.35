...
\"\n\
checkout_executable TCLSH \"/home/dell3/lh/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/dell3/lh/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
Queue/lhqueue set drop_front_ false\n\
Queue/lhqueue set summarystats_ false\n\
Queue/lhqueue set queue_in_bytes_ false\n\
Queue/lhqueue set mean_pktsize_ 500\n\
\n\
Queue/DTQueue set drop_front_ false\n\
Queue/DTQueue set summarystats_ false\n\
Queue/DTQueue set queue_in_bytes_ false\n\
Queue/DTQueue set mean_pktsize_ 500\n\
\n\
\n\
...
Agent/TCP/Newreno set flowid_ 0\n\
\n\
