...
df=pd.read_table("dt_real_thr_sta.txt",header=None,delim_whitespace=True,names=['time','id'])
...
for i in range(datanum):
    ...
    if now_time-last_time>interval:
        lf_thr=lf_num*1500*8.0/interval/1000000000/2
        sf_thr=sf_num*1500*8.0/interval/1000000000/2
        row.append(now_time)
        row.append(lf_thr)
        row.append(sf_thr)
